...
| Disciplina | Carga Horária | Status |
|------------|---------------|--------|
| 🏗️ **Infraestrutura de Tecnologia da Informação** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🌐 **Redes sem Fio** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔄 **Tecnologias em Switching** | 80h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| ☁️ **Computação em Nuvem** | 80h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔐 **Segurança da Informação** | 80h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🌍 **Diversidade Étnico-Cultural** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
...
| Disciplina | Carga Horária | Status |
|------------|---------------|--------|
| 💼 **Empreendedorismo** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🏗️ **Arquitetura de Sistemas Distribuídos** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🌐 **Redes Heterogêneas e Conectividades** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔧 **Administração de Redes** | 80h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🛠️ **Administração de Servidores** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔗 **Conectividade de Redes** | 80h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
...
| Disciplina | Carga Horária | Status |
|------------|---------------|--------|
| 🇧🇷 **Língua Portuguesa** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🏛️ **Organização e Arquitetura de Computadores** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 💻 **Programação de Computadores** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🌐 **Redes de Computadores** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| ⚙️ **Sistemas Operacionais** | 60h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔧 **Princípios de Administração e Marketing** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
...
|-------|---------------|--------|
| 🌐 **Conceitos Básicos de Redes** | 30h | ![Status](https://img.shields.io/badge/Status-Preparação-orange) |
| 🔧 **Dispositivos de Rede e Configuração** | 35h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 📊 **Endereçamento de Rede** | 25h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🛡️ **Suporte e Segurança de Rede** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
...
| Curso | Carga Horária | Status |
|-------|---------------|--------|
| 🛡️ **Introdução à Cibersegurança** | 25h | ![Status](https://img.shields.io/badge/Status-Preparação-orange) |
| 🌐 **Conceitos Básicos de Redes** | 30h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🔧 **Dispositivos de Rede e Configuração Inicial** | 35h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🖥️ **Segurança de Endpoint** | 40h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🛡️ **Defesa de Rede** | 45h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
| 🎯 **Gerenciamento de Ameaças Cibernéticas** | 35h | ![Status](https://img.shields.io/badge/Status-Planejado-blue) |
